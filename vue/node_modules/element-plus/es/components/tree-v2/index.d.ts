export declare const ElTreeV2: import("../../utils/types").SFCWithInstall<import("vue").DefineComponent<{
    readonly data: import("../../utils/props").BuildPropReturn<import("../../utils/props").PropWrapper<import("./src/types").TreeData>, () => [], unknown, unknown, unknown>;
    ...
    readonly props: import("../../utils/props").BuildPropReturn<import("../../utils/props").PropWrapper<import("./src/types").TreeOptionProps>, () => import("../../utils/types").Mutable<{
    ...
    readonly defaultCheckedKeys: import("../../utils/props").BuildPropReturn<import("../../utils/props").PropWrapper<import("./src/types").TreeKey[]>, () => [], unknown, unknown, unknown>;
    readonly checkStrictly: import("../../utils/props").BuildPropReturn<BooleanConstructor, false, unknown, unknown, unknown>;
    readonly defaultExpandedKeys: import("../../utils/props").BuildPropReturn<import("../../utils/props").PropWrapper<import("./src/types").TreeKey[]>, () => [], unknown, unknown, unknown>;
    ...
    readonly currentNodeKey: import("../../utils/props").BuildPropReturn<import("../../utils/props").PropWrapper<import("./src/types").TreeKey>, unknown, unknown, unknown, unknown>;
    ...
    filterMethod?: import("./src/types").FilterMethod | undefined;
    currentNodeKey?: import("../../utils/props").BuildPropType<import("../../utils/props").PropWrapper<import("./src/types").TreeKey>, unknown, unknown> | undefined;
}> & {
    ...
    "onNode-click"?: ((data: import("../tree/src/tree.type").TreeNodeData, node: import("./src/types").TreeNode) => any) | undefined;
    ...
    checkOnClickNode: import("../../utils/props").BuildPropType<BooleanConstructor, unknown, unknown>;
    highlightCurrent: import("../../utils/props").BuildPropType<BooleanConstructor, unknown, unknown>;
    currentNodeKey: import("../../utils/props").BuildPropType<import("../../utils/props").PropWrapper<import("./src/types").TreeKey>, unknown, unknown>;
    perfMode: import("../../utils/props").BuildPropType<BooleanConstructor, unknown, unknown>;
}>> & Record<string, any>;

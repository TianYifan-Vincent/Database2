...
declare const _Cascader: SFCWithInstall<import("vue").DefineComponent<{
    ...
    popperPaneRef: import("vue").ComputedRef<import("../popper/src/use-popper").RefElement | undefined>;
    input: import("vue").Ref<({
        ...
        $options: import("vue").ComponentOptionsBase<Readonly<{
            ...
            computedTextareaStyle: import("vue").ComputedRef<import("element-plus/es/utils/types").StyleValue>;
